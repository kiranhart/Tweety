...
public abstract class VisualTool extends BlockTool {
	...
	/**
	 * @see ca.tweetzy.tweety.menu.tool.Tool#onHotbarFocused(org.bukkit.entity.Player)
	 */
	@Override
	...
	/**
	 * @see ca.tweetzy.tweety.menu.tool.Tool#onHotbarDefocused(org.bukkit.entity.Player)
	 */
	@Override
