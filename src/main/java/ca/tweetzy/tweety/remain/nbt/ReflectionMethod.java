...
enum ReflectionMethod {
	...
	public Object run(Object target, Object... args) {
		if (this.method == null)
			throw new TweetyException("Method not loaded! '" + this + "'");
		try {
			return this.method.invoke(target, args);
		} catch (final Exception ex) {
			throw new TweetyException(ex, "Error while calling the method '" + this.methodName + "', loaded: " + this.loaded + ", Enum: " + this + " Passed Class: " + target.getClass());
		}
	}
	 ...
	 */
	public ca.tweetzy.tweety.remain.nbt.ClassWrapper getParentClassWrapper() {
