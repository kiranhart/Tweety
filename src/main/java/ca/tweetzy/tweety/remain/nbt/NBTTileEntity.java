...
public class NBTTileEntity extends NBTCompound {
	...
	public NBTCompound getPersistentDataContainer() {
		...
		if (ca.tweetzy.tweety.MinecraftVersion.olderThan(ca.tweetzy.tweety.MinecraftVersion.V.v1_14))
			throw new TweetyException("getPersistentDataContainer requires MC 1.14 or newer");
