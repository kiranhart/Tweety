...
public final class NmsEntity {
	...
	public NmsEntity(final Location location, final Class<?> entityClass) {
		try {
			...
			throw new TweetyException(t, "Failed to setup entity reflection! MC version: " + MinecraftVersion.getCurrent());
		}
	...
	private Object createEntity(final Location location, final Class<?> entityClass) {
		try {
			...
			throw new TweetyException(e, "Error creating entity " + entityClass + " at " + location);
		}
	}
	...
	public <T extends Entity> T addEntity(final SpawnReason reason) {
		try {
			...
			throw new TweetyException(e, "Error creating entity " + nmsEntity + " for " + reason);
		}
	}
	...
	public Entity getBukkitEntity() {
		try {
			...
			throw new TweetyException(e, "Error getting bukkit entity from " + nmsEntity);
		}
	}
}
...
final class NmsAccessor {
	...
	static {
		try {
			...
			throw new TweetyException(ex, "Error setting up nms entity accessor!");
		}
	}
