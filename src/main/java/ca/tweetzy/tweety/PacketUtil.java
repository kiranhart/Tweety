...
public final class PacketUtil {
	...
	public static class SimpleAdapter extends PacketAdapter {
		...
		@Override
		public void onPacketReceiving(final PacketEvent event) {
			throw new TweetyException("Override onPacketReceiving to handle receiving client>server packet type " + this.type);
		}
		...
		@Override
		public void onPacketSending(final PacketEvent event) {
			throw new TweetyException("Override onPacketReceiving to handle sending server>client packet type " + this.type);
		}
	}
}
