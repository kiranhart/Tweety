...
public abstract class Menu {
	...
	public static final Menu getMenu(final Player player) {
		return getMenu0(player, TweetyConstants.NBT.TAG_MENU_CURRENT);
	}
	...
	public Menu newInstance() {
		...
		throw new TweetyException("Could not instantiate menu of " + getClass() + ", override the method 'newInstance()' or ensure you have a public constructor which takes only one parameter ");
	}
	...
	/**
	 * If true, the menu listener will not exlcude shift clicks
	 *
	 * @return
	 */
