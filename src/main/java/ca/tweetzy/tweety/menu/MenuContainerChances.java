...
public abstract class MenuContainerChances extends Menu implements MenuQuantitable {
	...
	/**
	 * @see ca.tweetzy.tweety.menu.MenuQuantitable#getQuantityButtonPosition()
	 */
	@Override
	...
	/**
	 * @see ca.tweetzy.tweety.menu.MenuQuantitable#allowDecimalQuantities()
	 */
	@Override
	...
	/**
	 * @see ca.tweetzy.tweety.menu.MenuQuantitable#getLevelLoreLabel()
	 */
	@Override
	...
	/**
	 * @see ca.tweetzy.tweety.menu.MenuQuantitable#quantitiesArePercents()
	 */
	@Override
