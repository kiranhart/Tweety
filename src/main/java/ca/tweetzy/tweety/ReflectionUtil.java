...
public final class ReflectionUtil {
	...
	public static Constructor<?> getConstructor(@NonNull final Class<?> clazz, final Class<?>... params) {
		try {
			...
			throw new TweetyException(ex, "Could not get constructor of " + clazz + " with parameters " + Common.join(params));
		}
	}
	...
	public static void setStaticField(@NonNull final Class<?> clazz, final String fieldName, final Object fieldValue) {
		try {
			...
			throw new TweetyException(t, "Could not set " + fieldName + " in " + clazz + " to " + fieldValue);
		}
	}
	...
	public static <T> T instantiate(final Constructor<T> constructor, final Object... params) {
		try {
			...
			throw new TweetyException(ex, "Could not make new instance of " + constructor + " with params: " + Common.join(params));
		}
	}
	 ...
	 */
	public static final class ReflectionException extends TweetyException {
