...
import ca.tweetzy.tweety.gui.methods.Clickable;
...
public class SimplePagedGui extends Gui {
	...
	public SimplePagedGui(Gui parent) {
		...
		nextPage = GuiUtils.createButtonItem(CompMaterial.ARROW, "Next Page");
		prevPage = GuiUtils.createButtonItem(CompMaterial.ARROW, "Previous Page");
	}
