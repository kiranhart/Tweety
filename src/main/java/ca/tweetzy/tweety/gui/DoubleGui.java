...
public class DoubleGui extends Gui {
	...
	public DoubleGui highlightPlayerItem(int cell) {
		...
		if (item != null) {
			setPlayerItem(cell, ItemCreator.of(item).glow(true).make());
		}
	...
	@Override
	public DoubleGui updateItem(int row, int col, CompMaterial itemTo, String title, String... lore) {
		return (DoubleGui) super.updateItem(col + row * 9, itemTo, title, lore);
	}

	@Override
	public DoubleGui updateItem(int cell, CompMaterial itemTo, String title, String... lore) {
		return (DoubleGui) super.updateItem(cell, itemTo, title, lore);
	}
	...
	@Override
	public DoubleGui updateItem(int row, int col, CompMaterial itemTo, String title, List<String> lore) {
		return (DoubleGui) super.updateItem(col + row * 9, itemTo, title, lore);
	}

	@Override
	public DoubleGui updateItem(int cell, CompMaterial itemTo, String title, List<String> lore) {
		return (DoubleGui) super.updateItem(cell, itemTo, title, lore);
	}
