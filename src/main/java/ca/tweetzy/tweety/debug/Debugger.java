...
public final class Debugger {
	...
	public static List<String> traceRoute(boolean trackLineNumbers) {
		...
		for (final StackTraceElement el : exception.getStackTrace()) {
			...
			if (line.contains("org.bukkit.plugin.java.JavaPluginLoader") || line.contains("org.bukkit.plugin.TweetyPluginManager") || line.contains("org.bukkit.plugin.JavaPlugin"))
				continue;
	...
	public static void printStackTrace(@NonNull Throwable throwable) {
		...
		if (throwable instanceof TweetyException && !causes.isEmpty()) {
