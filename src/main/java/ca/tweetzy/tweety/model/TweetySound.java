...
public final class TweetySound {
	 ...
	 * @param pitch
	 */
	public TweetySound(Sound sound, float volume, float pitch) {
	 ...
	 * @param volume
	 */
	public TweetySound(Sound sound, float volume) {
	 ...
	 * @param line
	 */
	public TweetySound(String line) {
