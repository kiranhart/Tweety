...
public final class ChatPaginator {
	 ...
	 * if you use {@link #setTweetyHeader(String)}.
	 *
	 * It is 17 because our header is 3 lines wide.
	 */
	public static final int Tweety_HEIGHT = 15;
	...
	/**
	 * Sets the standard Tweety header used across plugins.
	 * ----------------
	 * \<center\>title
	 * ---------------
	 *
	 ...
	 * @return
	 */
	public ChatPaginator setTweetyHeader(String title) {
	...
	public void send(CommandSender sender, int page) {
		if (sender instanceof Player) {
			...
			// Remove old FoPages to prevent conflicts when two or more plugins use Tweety shaded
