 ...
 */
@Getter
public final class TweetyTime {

	private final String raw;
	private final long timeTicks;

	protected TweetyTime(@NonNull final String time) {
	 ...
	 * @return
	 */
	public static TweetyTime fromSeconds(final int seconds) {
	 ...
	 * @return
	 */
	public static TweetyTime from(final String time) {
		return new TweetyTime(time);
	}
	...
	public boolean equals(Object obj) {
		return obj instanceof TweetyTime && ((TweetyTime) obj).timeTicks == this.timeTicks;
	}
