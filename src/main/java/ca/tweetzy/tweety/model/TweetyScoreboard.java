...
public class TweetyScoreboard {
	 ...
	 */
	@Getter
	private final static List<TweetyScoreboard> registeredBoards = new ArrayList<>();
	...
	public static final void clearBoardsFor(final Player player) {
		for (final TweetyScoreboard scoreboard : registeredBoards)
		...
		updateTask = new BukkitRunnable() {
			...
			public void run() {
				...
				try {
					...
					Common.error(t,
							"Error displaying " + TweetyScoreboard.this,
							"Entries: " + lines,
							"%error",
